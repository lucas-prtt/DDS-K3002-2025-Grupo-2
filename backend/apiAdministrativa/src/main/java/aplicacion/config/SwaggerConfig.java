    ...
    public OpenAPI customOpenAPI() {
        ...
        paths.addPathItem("/apiAdministrativa/fuentesProxy", new PathItem()
                .post(new Operation()
                        ...
                        .description("Registra una nueva fuente proxy externa para importar hechos")
                        .requestBody(new RequestBody()
                                .required(true)
                                .content(new Content()
                                        .addMediaType("application/json",
        ...
        paths.addPathItem("/apiAdministrativa/hechos", new PathItem()
                .get(new Operation()
                        ...
                        .description("Obtiene hechos filtrados por fecha o estado de revisión (pendientes)")
                        .addParametersItem(new Parameter()
                                .name("fechaMayorA")
                                .in("query")
                                .required(false)
        ...
        // ============= CONTRIBUYENTES =============
        paths.addPathItem("/apiAdministrativa/contribuyentes/{id}/hechos", new PathItem()
                .get(new Operation()
                        .tags(List.of("contribuyente-controller"))
                        .summary("Obtener hechos de un contribuyente")
                        .description("Obtiene todos los hechos reportados por un contribuyente específico")
                        .addParametersItem(new Parameter()
                                .name("id")
                                .in("path")
                                .required(true)
                                .description("ID del contribuyente")
                                .schema(new StringSchema().example("contrib-123"))
                        )
                        .responses(new ApiResponses()
                                .addApiResponse("200", new ApiResponse()
                                        .description("Lista de hechos del contribuyente obtenida exitosamente")
                                        .content(new Content()
                                                .addMediaType("application/json",
                                                        new MediaType()
                                                                .schema(new ArraySchema()
                                                                        .items(new ObjectSchema()
                                                                                .addProperty("id", new StringSchema().example("hecho-123"))
                                                                                .addProperty("titulo", new StringSchema().example("Incendio forestal"))
                                                                                .addProperty("descripcion", new StringSchema().example("Incendio en zona rural"))
                                                                                .addProperty("fechaAcontecimiento", new StringSchema().example("2024-01-15T10:30:00"))
                                                                                .addProperty("estadoRevision", new StringSchema().example("ACEPTADO"))
                                                                        )
                                                                )
