                                        ...
                                        .addMediaType("application/json",
                                                new MediaType()
                                                        .schema(new ObjectSchema()
                                                                ...
                                                                .addProperty("motivo", new StringSchema().example(""))
                                                        )
                                        )
                                )
                        )
