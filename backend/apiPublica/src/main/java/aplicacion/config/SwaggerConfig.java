    ...
    public OpenAPI customOpenAPI() {
        ...
        paths.addPathItem("/apiPublica/contribuyentes/{id}/hechos", new PathItem()
                .get(new Operation()
                        ...
                        .description("Devuelve la lista paginada de hechos asociados a un contribuyente. La respuesta incluye metadatos de paginación y ordenamiento por visible descendente (primero los visibles, luego los eliminados).")
                        .addParametersItem(new Parameter()
                                .name("id")
                                .in("path")
                                .required(true)
                        ...
                        .responses(new ApiResponses()
                                .addApiResponse("200", new ApiResponse()
                                        .description("Respuesta paginada con lista de hechos del contribuyente")
                                        .content(new Content().addMediaType("application/json",
                                                new MediaType().schema(
                                                        new ObjectSchema()
                                                                .addProperty("content", new ArraySchema()
                                                                        .items(new ObjectSchema()
                                                                                ...
                                                                                .addProperty("fechaAcontecimiento", new StringSchema().format("date-time").example("2025-11-29T15:30:00"))
                                                                                .addProperty("fechaCarga", new StringSchema().format("date-time").example("2025-11-29T16:00:00"))
                                                                                .addProperty("fechaUltimaModificacion", new StringSchema().format("date-time").example("2025-11-29T16:00:00"))
                                                                                .addProperty("origen", new StringSchema().example("CARGA_MANUAL"))
                                                                                .addProperty("contenidoTexto", new StringSchema().example("Descripción detallada del hecho"))
                                                                                ...
                                                                                .addProperty("visible", new BooleanSchema().example(true).description("Indica si el hecho está visible o ha sido eliminado"))
                                                                                .addProperty("autor", new ObjectSchema()
                                                                                        .addProperty("id", new StringSchema().example("123"))
                                                                                        .addProperty("esAdministrador", new BooleanSchema().example(false))
                                                                                        .addProperty("identidad", new ObjectSchema()
                                                                                                .addProperty("nombre", new StringSchema().example("Juan"))
                                                                                                .addProperty("apellido", new StringSchema().example("Pérez"))
                                                                ...
                                                                .addProperty("totalElements", new IntegerSchema().example(50).description("Total de elementos en todas las páginas"))
                                                                .addProperty("totalPages", new IntegerSchema().example(3).description("Total de páginas"))
                                                                .addProperty("size", new IntegerSchema().example(20).description("Tamaño de la página"))
                                                                .addProperty("number", new IntegerSchema().example(0).description("Número de página actual (base 0)"))
                                                                .addProperty("first", new BooleanSchema().example(true).description("Indica si es la primera página"))
                                                                .addProperty("last", new BooleanSchema().example(false).description("Indica si es la última página"))
                                                                .addProperty("empty", new BooleanSchema().example(false).description("Indica si la página está vacía"))
                                                )
                                        ))
                                )
                                .addApiResponse("404", new ApiResponse().description("Contribuyente no encontrado"))
                        )
                )
        );
        ...
        paths.addPathItem("/apiPublica/hechos", new PathItem()
                .get(new Operation()
                        ...
                        .addParametersItem(new Parameter()
                                ...
                                .description("Incluir el campo 'id' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeTitulo")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(true))
                                .description("Incluir el campo 'titulo' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeDescripcion")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(false))
                                .description("Incluir el campo 'descripcion' en la respuesta")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeLatitud")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(true))
                                .description("Incluir el campo 'latitud' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeLongitud")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(true))
                                .description("Incluir el campo 'longitud' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeCategoria")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(true))
                                .description("Incluir el campo 'categoria' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeFechaCarga")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(true))
                                .description("Incluir el campo 'fechaCarga' en la respuesta (activado por defecto)")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeFechaAcontecimiento")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(false))
                                .description("Incluir el campo 'fechaAcontecimiento' en la respuesta")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeFechaUltimaModificacion")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(false))
                                .description("Incluir el campo 'fechaUltimaModificacion' en la respuesta")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeContenidoTexto")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(false))
                                .description("Incluir el campo 'contenidoTexto' en la respuesta")
                        )
                        .addParametersItem(new Parameter()
                                .name("includeAnonimato")
                                .in("query")
                                .required(false)
                                .schema(new io.swagger.v3.oas.models.media.BooleanSchema()._default(false))
                                .description("Incluir el campo 'anonimato' en la respuesta")
                        )
                        .responses(new ApiResponses()
