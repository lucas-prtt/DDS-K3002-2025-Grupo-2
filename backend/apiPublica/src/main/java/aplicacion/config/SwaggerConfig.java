                                        ...
                                        .addMediaType("application/json",
                                                new MediaType()
                                                        .schema(new ObjectSchema()
                                                                ...
                                                                .addProperties("motivo", new StringSchema().example(""))
                                                        )
                                        )
                                )
                        )
                                                        ...
                                                        new ArraySchema()
                                                                .items(new ObjectSchema()
                                                                        ...
                                                                        .addProperties("identidad", new ObjectSchema()
                                                                                .addProperties("nombre", new StringSchema().example("string"))
                                                                                .addProperties("apellido", new StringSchema().example("string"))
                                                                                .addProperties("fechaNacimiento", new StringSchema().format("date").example("2025-11-28"))
                                                                        )
                                                                        .addProperties("mail", new StringSchema().example("string"))
                                                                )
                                                )
                                        ))
                                )
        ...
        paths.addPathItem("/apiPublica/contribuyentes/{id}/identidad", new PathItem()
                .patch(new Operation()
                        ...
                        .requestBody(new RequestBody()
                                ...
                                .content(new Content().addMediaType("application/json",
                                        new MediaType().schema(new ObjectSchema()
                                                .addProperty("nombre", new StringSchema().example("Agustin Herzkovich"))
                                                .addProperty("documento", new StringSchema().example("45321621"))
                                                ...
                                                new MediaType().schema(
                                                        new ArraySchema()
                                                                .items(new ObjectSchema()
                                                                        ...
                                                                        .addProperties("titulo", new StringSchema().example("string"))
                                                                        .addProperties("descripcion", new StringSchema().example("string"))
                                                                        .addProperties("categoria", new ObjectSchema()
                                                                                .addProperties("id", new IntegerSchema().example(0))
                                                                                .addProperties("nombre", new StringSchema().example("string"))
                                                                        )
                                                                        .addProperties("ubicacion", new ObjectSchema()
                                                                                .addProperties("latitud", new NumberSchema().example(0))
                                                                                .addProperties("longitud", new NumberSchema().example(0))
                                                                        )
                                                                        .addProperties("fechaAcontecimiento", new StringSchema().format("date-time").example("2025-11-29T00:04:33.303Z"))
                                                                        .addProperties("fechaCarga", new StringSchema().format("date-time").example("2025-11-29T00:04:33.303Z"))
                                                                        .addProperties("fechaUltimaModificacion", new StringSchema().format("date-time").example("2025-11-29T00:04:33.303Z"))
                                                                        .addProperties("origen", new StringSchema().example("CARGA_MANUAL"))
                                                                        .addProperties("contenidoTexto", new StringSchema().example("string"))
                                                                        .addProperties("contenidoMultimedia", new ArraySchema()
                                                                                .items(new ObjectSchema()
                                                                                        .addProperties("id", new IntegerSchema().example(0))
                                                                                        .addProperties("url", new StringSchema().example("string"))
                                                                                )
                                                                        )
                                                                        .addProperties("anonimato", new BooleanSchema().example(true))
                                                                        .addProperties("autor", new ObjectSchema()
                                                                                .addProperties("id", new IntegerSchema().example(0))
                                                                                .addProperties("esAdministrador", new BooleanSchema().example(true))
                                                                                .addProperties("identidad", new ObjectSchema()
                                                                                        .addProperties("nombre", new StringSchema().example("string"))
                                                                                        .addProperties("apellido", new StringSchema().example("string"))
                                                                                        .addProperties("fechaNacimiento", new StringSchema().format("date").example("2025-11-29"))
                                                                                )
                                                                                .addProperties("mail", new StringSchema().example("string"))
                                                                        )
                                                                        .addProperties("etiquetas", new ArraySchema()
                                                                                .items(new ObjectSchema()
                                                                                        .addProperties("nombre", new StringSchema().example("string"))
                                                                                )
                                                                        )
...
// ApiResponse reutilizable para lista paginada de hechos
        ApiResponse paginatedHechosResponse = new ApiResponse()
                ...
                .content(new Content().addMediaType("application/json",
                        new MediaType().schema(
                                new ObjectSchema()
                                        .addProperties("totalElements", new IntegerSchema().example(0))
                                        .addProperties("totalPages", new IntegerSchema().example(0))
                                        .addProperties("first", new BooleanSchema().example(true))
                                        .addProperties("last", new BooleanSchema().example(true))
                                        .addProperties("size", new IntegerSchema().example(0))
                                        .addProperties("content", new ArraySchema()
                                                .items(new ObjectSchema()
                                                        .addProperties("id", new StringSchema().example("string"))
                                                        .addProperties("titulo", new StringSchema().example("string"))
                                                        .addProperties("descripcion", new StringSchema().example("string"))
                                                        ...
                                                        .addProperties("fechaAcontecimiento", new StringSchema().format("date-time").example("2025-11-29T00:06:57.260Z"))
                                                        .addProperties("fechaCarga", new StringSchema().format("date-time").example("2025-11-29T00:06:57.260Z"))
                                                        .addProperties("fechaUltimaModificacion", new StringSchema().format("date-time").example("2025-11-29T00:06:57.260Z"))
                                                        .addProperties("origen", new StringSchema().example("CARGA_MANUAL"))
                                                        .addProperties("contenidoTexto", new StringSchema().example("string"))
                                                        .addProperties("contenidoMultimedia", new ArraySchema()
                                                                .items(new ObjectSchema()
                                        ...
                                        .addProperties("number", new IntegerSchema().example(0))
                                        .addProperties("numberOfElements", new IntegerSchema().example(0))
                                        .addProperties("pageable", new ObjectSchema()
                                                .addProperties("offset", new IntegerSchema().example(0))
                                                .addProperties("pageNumber", new IntegerSchema().example(0))
                                                .addProperties("pageSize", new IntegerSchema().example(0))
                                                .addProperties("sort", new ObjectSchema()
                                                        .addProperties("empty", new BooleanSchema().example(true))
                                                        .addProperties("sorted", new BooleanSchema().example(true))
                                                        .addProperties("unsorted", new BooleanSchema().example(true))
                                                )
                                                .addProperties("unpaged", new BooleanSchema().example(true))
                                                .addProperties("paged", new BooleanSchema().example(true))
                                        )
                                        .addProperties("sort", new ObjectSchema()
                                                .addProperties("empty", new BooleanSchema().example(true))
                                                .addProperties("sorted", new BooleanSchema().example(true))
                                                        ...
                                                        new ObjectSchema()
                                                                ...
                                                                .addProperties("content", new ArraySchema()
                                                                        .items(new ObjectSchema()
                                                                                ...
                                                                                .addProperties("titulo", new StringSchema().example("string"))
                                                                                .addProperties("descripcion", new StringSchema().example("string"))
                                                                                .addProperties("criteriosDePertenencia", new ArraySchema()
                                                                                        .items(new ObjectSchema()
                                                                                                .addProperties("id", new IntegerSchema().example(0))
                                                                                        )
                                                                                )
                                                                                .addProperties("fuentes", new ArraySchema()
                                                                                        .items(new ObjectSchema()
                                                                                                .addProperties("id", new StringSchema().example("string"))
                                                                                                .addProperties("alias", new StringSchema().example("string"))
                                                                                        )
                                                                                )
                                                                                .addProperties("tipoAlgoritmoConsenso", new StringSchema().example("IRRESTRICTO"))
                                                                        )
                                                                )
                                                                .addProperties("pageable", new ObjectSchema()
                                                                        .addProperties("offset", new IntegerSchema().example(0))
