document.addEventListener("DOMContentLoaded", function () {
    ...
    const endpoint = window.isAdmin ? `http://localhost:8086/apiAdministrativa/contribuyentes/${autorId}/hechos` : `http://localhost:8082/fuentesDinamicas/contribuyentes/${autorId}/hechos`;
                ...
                if (hechos.length !== 0) {
                        ...
                        html += `
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6>${hecho.titulo}</h6>
                                    <button th:id="btn-editar-hecho-${hecho.id}" th:data-hecho="${hecho}" class="btn-primary btn-sm">
                                        Editar
                                    </button>
                                </div>
                    ...
                    listaMisHechos.innerHTML = `
                        <div class="gap-[2rem] flex flex-col items-center py-[2rem]">
                            ...
                            <button id="open-modal-crear-hecho" class="btn-tertiary flex gap-2">
